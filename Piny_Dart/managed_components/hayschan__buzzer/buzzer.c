...
const uint16_t notes[] = {0,    31,   33,   35,   37,   39,   41,   44,   46,   49,   52,   55,   58,   62,   65,
                          69,   73,   78,   82,   87,   93,   98,   104,  110,  117,  123,  131,  139,  147,  156,
...
esp_err_t buzzer_init(int buzzerPin)
{
    ...
    ledc_timer.clk_cfg = LEDC_AUTO_CLK;              // clock configuration
...
void buzzer(piano_note_t current_note, uint32_t current_loudness, float loud_time, float no_loud_time,
            uint8_t loud_cycle_time)
{
